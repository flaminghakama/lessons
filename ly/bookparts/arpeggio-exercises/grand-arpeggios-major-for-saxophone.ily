...
\bookpart {
    ...
    \score {
        ...
        << 
            ...
            \new Staff {
                \include "ly/ily/staff-properties.ily"
                \transpose c g \grandArpeggioMajorTwo
            }
        >>
    }
    \score {
    ...
    \score {
        ...
        << 
            ...
            \new Staff {
                \include "ly/ily/staff-properties.ily"
                \transpose c d \grandArpeggioMajor
            }
        >>
    }
    \score {
        ...
        << 
            ...
            \new Staff {
                \include "ly/ily/staff-properties.ily"
                \transpose c bf \grandArpeggioMajorTwo
            }
            \new ChordNames \transpose c bf' { \grandArpeggioMajorChords }
            \new Staff {
                \include "ly/ily/staff-properties.ily"
    ...
    \score {
        ...
        << 
            ...
            \new Staff {
                \include "ly/ily/staff-properties.ily"
                \transpose c a \grandArpeggioMajorTwo
            }
        >>
    }
    \score {
    ...
    \score {
        ...
        << 
            ...
            \new Staff {
                \include "ly/ily/staff-properties.ily"
                \transpose c af \grandArpeggioMajorTwo
            }
        >>
    }
    ...
    \score {
        ...
        << 
            ...
            \new Staff {
                \include "ly/ily/staff-properties.ily"
                \transpose c df \grandArpeggioMajor
            }
        >>
    }
    ...
    \score {
        ...
        << 
            ...
            \new Staff {
                \include "ly/ily/staff-properties.ily"
                \transpose c fs \grandArpeggioMajorTwo
            }
        >>
    }
    \score {
    ...
    \score {
        ...
        << 
            ...
            \new Staff {
                \include "ly/ily/staff-properties.ily"
                \transpose c cf' \grandArpeggioMajorTwo
            }
        >>
    }
}
