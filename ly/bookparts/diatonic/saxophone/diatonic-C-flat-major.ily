    ...
    \bookpart {
        ...
        \score {
            << 
                ...
                \new Staff {
                    \include "ly/ily/staff-properties.ily"
                    \transpose b, cf \dominantArpeggioFSharp
                    \noPageBreak
                }
            >>
            \header {
