pentatonicExerciseOneCMinor = \relative c' { 
    ...
    \tuplet 3/2 4 { c8 bf c  ef c ef  f ef f  g f g | bf g bf  c bf ef } c2 | 
    \tuplet 3/2 4 { c8 bf c  ef c ef  f ef f  ef c ef } | c1 | 
...
pentatonicExerciseTwoCMinor = \relative c' { 
    ...
    \tuplet 3/2 4 { c8 bf g  ef' c bf  f' ef c  ef c bf } | c1 |
    

    \tuplet 3/2 4 { c8 ef f  bf,8 c ef  g, bf c  f, g bf  | ef, f g }  c,4 
    \tuplet 3/2 4 { c8 ef f  bf, c ef | g, bf c  f,8 g bf  ef, f g  c, ef f  | bf, c ef } c2. |
    \bar "|." 
}
...
pentatonicExerciseFourCMinor = \relative c' { 
    ...
    \time 4/4
    \tuplet 3/2 4 { 
        c8 ef f  g bf g  ef f g  bf c bf |
        f8 g bf  c ef c  g bf c  ef f ef |
        bf8 c ef  f g f } c2 | 
    \tuplet 3/2 4 { 
        c8 ef f  g bf g  ef f g  bf c bf |
        f8 g bf  c ef c  g bf c  ef f ef } | c1
    \tuplet 3/2 4 { 
        f8 ef c  bf g bf  ef c bf  g f g |
...
pentatonicExerciseFiveCMinor = \relative c' {
    ...
    f'8 ef c bf  gf [ f ef c ]  bf [ gf f ef ] | c bf c4 ~ 1 |
    \bar "|."
}
