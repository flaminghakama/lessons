articulationExerciseOne = \relative c'' { 
    ...
    \time 2/4
    \tempo 4=104-160
    a16 16 16 16 4 | \tag #'Speed { R2 }
    g16 16 16 16 4 | \tag #'Speed { R2^"etc. ..." }
...
articulationExerciseTwo = \relative c'' { 
    ...
    \time 2/4
    \tempo 4=108-160
    a16 b16 c16 b16 a4 | \tag #'Speed { R2 }
    g16 a16 b16 a16 g4 | \tag #'Speed { R2^"etc. ..." }
    \tag #'Normal \relative c' {
        f16 g16 a16 g16 f4 |
        e16 f16 g16 f16 e4 |
        d16 e16 f16 e16 d4 |
...
articulationExerciseThree = \relative c'' { 
    ...
    \time 2/4
    \tempo 4=108-160
    a16 c16 e16 c16 a4 | \tag #'Speed { R2 }
    g16 b16 d16 b16 g4 | | \tag #'Speed { R2^"etc. ..." }
    \tag #'Normal \relative c' {
        f16 a16 c16 a16 f4 |
        e16 g16 b16 g16 e4 |
        d16 f16 a16 f16 d4 |
...
articulationExerciseFour = \relative c'' { 
    ...
    \tag #'Speed { \time 3/4 }
    \tempo 4=120-152
    a16 16 16 16  16 16 16 16  4 \tag #'Normal { r4 } | \tag #'Speed { R2. }
    g16 16 16 16  16 16 16 16  4 \tag #'Normal { r4 } | \tag #'Speed { R2.^"etc. ..." }
    \tag #'Normal \relative c' {
        ...
        f16 16 16 16  16 16 16 16  4  r4 |
        e16 16 16 16  16 16 16 16  4  r4 |
        e16 f g a  g a b c  b c d e  d f g b | 
        c1 |
...
articulationExerciseFive = \relative c'' {
    ...
    \tag #'Speed { \time 3/4 }
    \tempo 4=108-160
    a16 b16 c16 b16  a16 b16 c16 b16 a4 \tag #'Normal { r4 } | \tag #'Speed { R2. }
    g16 a16 b16 a16  g16 a16 b16 a16 g4  \tag #'Normal { r4 } | \tag #'Speed { R2.^"etc. ..." }
    \tag #'Normal \relative c' { 
...
articulationExerciseSix = \relative c'' {
    ...
    \tag #'Speed { \time 3/4 }
    \tempo 4=120-152
    a16 c16 e16 c16  a16 c16 e16 c16 a4 \tag #'Normal { r4 } | \tag #'Speed { R2. }
    g16 b16 d16 b16  g16 b16 d16 b16 g4 \tag #'Normal { r4 } | \tag #'Speed { R2.^"etc. ..." }
    \tag #'Normal \relative c' {
        ...
        f16 a16 c16 a16  f16 a16 c16 a16 f4 r4 |
        e16 g16 b16 g16  e16 g16 b16 g16 e4 r4 |
        f16 c' a f   d' b g e'  c a f' d  b g' e d | 
        c1 |  

        b'16 g16 e16 g16  b16 g16 e16 g16 b4 r4 |
...
articulationExerciseSeven = \relative c'' { 
    ...
    a16 16 16 16  16 16 16 16  16 16 16 16 
        \tag #'Normal \relative c'' { | a4 r2 } 
        \tag #'Speed \relative c'' { a4 | R1 } |
    g16 16 16 16  16 16 16 16  16 16 16 16 
        \tag #'Normal \relative c'' { | g4 r2 } 
        \tag #'Speed \relative c'' { g4 | R1^"etc. ..." } |
    \tag #'Normal \relative c' {  
