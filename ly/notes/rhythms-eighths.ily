...
rhythmsEighthsExerciseTwoMajor = \relative c'' { 
    \key g \major
    \time 4/4
...
rhythmsEighthsExerciseThreeMajor = \relative c' { 
    \key g \major
    \time 4/4
    r8 d g4 r c,8 d | e4-. a2. | r8 g fs4-. d8 e d e | g d g4 r2 | 
    \bar "|." 
}

rhythmsEighthsExerciseFourMajor = \relative c' { 
    \key g \major
    \time 3/4
...
rhythmsEighthsExerciseSixMajor = \relative c' { 
    \key c \major
    \time 4/4
...
rhythmsEighthsExerciseSevenMajor = \relative c' { 
    \key c \major
    \time 4/4
...
rhythmsEighthsExerciseEightMajor = \relative c'' { 
    \key c \major
    \time 4/4
...
rhythmsEighthsExerciseNineMajor = \relative c'' { 
    \key c \major
    \time 4/4
