...
instructionDb = \markup {
    \fill-line {
        \center-column {
            ...
            \null
            "Likewise, when the note C follows the note Db,"
            "or when the note Db follows the note C,"
            "one of them should be played with the Left hand"
        }
    }
}

diatonicExerciseOneDbMajor = \transpose c df \relative c' { 
    \key c \major
    \time 3/4
    c8 e g e c4 | 
    d8 f a f d4 | 
...
diatonicExerciseTwoDbMajor = \transpose c df \relative c' { 
    \key c \major
    \time 4/4
    c8 d e g  d e f a | 
    e8 f g b  f g a c | 
...
diatonicExerciseThreeDbMajor = \transpose c df \relative c' { 
    \key c \major
    \time 4/4
    c8 d e f  g f e c | 
    d8 e f g  a g f d | 
