...
diatonicExerciseOneCbMajor = \transpose c, cf \relative c { 
    \key c \major
    \time 3/4
    c8 e g e c4 | 
    d8 f a f d4 | 
...
diatonicExerciseTwoCbMajor = \transpose c, cf \relative c { 
    \key c \major
    \time 4/4
    c8 d e g  d e f a | 
    e8 f g b  f g a c | 
...
diatonicExerciseThreeCbMajor = \transpose c, cf \relative c { 
    \key c \major
    \time 4/4
    c8 d e f  g f e c | 
    d8 e f g  a g f d | 
