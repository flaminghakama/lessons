pentatonicExerciseZeroGSharpMinor = \relative c'' { 
    \key gs \minor
    \time 4/4
    gs1 | b | cs | ds | fs 
    \bar "||" 
    gs1 | <b b,,> | <cs cs,,> | <ds ds,,> | fs,, 
    \bar "||" \break
    \time 3/4
    gs2 b4 | cs ds fs | gs2 fs4 | ds cs b | gs2. |
    gs'2 fs4 | ds cs b | gs2 b4 | cs ds fs | gs2. |
    \bar "||" \break
    \time 4/4
    gs,8 cs b ds  cs fs ds gs | fs b gs2. | 
    gs8 ds fs cs  ds b cs gs | b fs gs2. |
    \bar "||" \break
    gs8 fs b gs  cs b ds cs | fs ds gs2. | 
    gs8 b fs gs  ds fs cs ds | b cs gs2. |
    \bar "|."
}

pentatonicExerciseOneGSharpMinor = \relative c'' { 
    \key gs \minor
    \time 4/4
    \tuplet 3/2 4 { 
...
pentatonicExerciseTwoGSharpMinor = \relative c'' { 
    \key gs \minor
    \time 3/4
    g4 \tuplet 3/2 4 {
        d8 c bf  f' d c |
...
pentatonicExerciseThreeGSharpMinor = \relative c'' { 
    \key gs \minor
    \time 4/4
    g2  f8 d c bf | 
    g'8 f d c  bf' g f d |
...
pentatonicExerciseFourGSharpMinor = \relative c'' { 
    \key gs \minor
    \time 4/4
    g1 
    \tuplet 3/2 4 {
...
pentatonicExerciseFiveGSharpMinor = \relative c'' {
    \key gs \minor
    \time 6/4
...
pentatonicExerciseFiveDSharpMinor = \relative c' {
    \key d \Sharpminor
    \time 6/4
...
pentatonicExerciseSixGSharpMinor = \relative c'' {
    \key gs \minor
    \time 4/4
    g8 bf, c df  d f g bf |
