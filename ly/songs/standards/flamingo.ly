...
titleRight = "mingo"
title = "Flamingo"
composerName = "T. Grovya & E. Anderson"
lyricistName = ""
...
killPreview
rm flamingo*.pdf
lilypond ly/songs/standards/flamingo.ly 
mv flamingo*.pdf pdf/songs/standards
for file in pdf/songs/standards/flamingo*.pdf ; do op $file ; done
