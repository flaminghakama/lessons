...
melodyChorus = \relative c'' { 
    ...
    ef8. af,16 ~  4  r8 ef'  d [ c ] | d4. c8 ~ 4 r | 
...
\book {
  \bookOutputSuffix "Bass-in-G-minor-for-C"
    \header {
        subtitle = "(original key)"
        poet = "Bass"
        instrumentName = \poet
...
\book {
  \bookOutputSuffix "Bass-in-F-minor-for-C"
    \header {
        subtitle = "(Elaine key)"
        poet = "Bass"
        instrumentName = \poet
