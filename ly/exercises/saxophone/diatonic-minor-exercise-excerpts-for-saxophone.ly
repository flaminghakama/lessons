...
titleLeft = "Diatonic Minor Exercise"
titleRight = " Excerpts for Saxophone"
titleFull = \markup \center-column { "Diatonic Minor Exercise" " Excerpts for Saxophone" }
...
%{
killPreview ; rm diatonic-minor-exercise-excerpts-for-saxophone*.pdf ; lilypond ly/exercises/saxophone/diatonic-minor-exercise-excerpts-for-saxophone.ly ; op diatonic-minor-exercise-excerpts-for-saxophone.pdf 

rm diatonic-minor-exercise-excerpts-for-saxophone*.pdf
lilypond ly/exercises/saxophone/diatonic-minor-exercise-excerpts-for-saxophone.ly
mv diatonic-minor-exercise-excerpts-for-saxophone.pdf pdf/exercises/saxophone
...
\book { 
    ...
    % \include "ly/bookparts/diatonic/saxophone/diatonic-excerpts-F-Minor.ily"

    % \include "ly/bookparts/diatonic/saxophone/diatonic-excerpts-D-Minor.ily"

    % \include "ly/bookparts/diatonic/saxophone/diatonic-excerpts-A-Minor.ily"
}
